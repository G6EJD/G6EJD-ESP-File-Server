...
#define SD_CARD_SELECT_PIN 5 // Change the pin number to suit your connections or board

// MicroSD card module	ESP32 typical connections, vary as required
// 3V3	3.3V
// CS	  GPIO 5
// MOSI	GPIO 23
// CLK  GPIO 18
// MISO	GPIO 19
// GND  GND
// Default pin assignments per device type
 // +--------------+---------+-------+----------+----------+----------+
...
//#define REASSIGN_PINS by using -1 for pin number, then redefine them
//int sck = -1;
//int miso = -1;
//int mosi = -1;
//int cs   = -1;
...
String HTML_Footer() {
  ...
  page += "<p class='ps'><i>Copyright &copy;&nbsp;D L Bird 2024 Version " +  Version + "</i></p>";
  page += "</footer>";
  page += "</body>";
  page += "</html>";
  return page;
